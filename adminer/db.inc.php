<?php
//include dirname(__FILE__) . "/include/lqkconstant.php";
//include_once dirname(__FILE__) . "/include/auth.inc.php";
...
//                $filterTbls = array('bl_players', 'bl_teams');
                foreach ($filterTbls as $filterTbl) {
                    if (strpos($name, $filterTbl) !== false) {
